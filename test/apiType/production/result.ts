...
export const postFirmCodeAssessSubmitAssess = <NUDATA extends (keyof AT_AssessModel)[] = []>(
	...
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Assess/SubmitAssess?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeAssessGetAssessById = <RNU extends (keyof AT_CheckViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowAssetApplyAssentAllocation = <NUDATA extends (keyof AT_AssentAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/AssentAllocation?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowAssetApplyGetAllocationAssetLederByApplyDetailsId = <RNU extends (keyof AT_AssetLedgerPageModel)[] = []>(
	applyDetailsId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowAssetApplyDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowAssetApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetApplyPendingAudit = <NUDATA extends (keyof AT_FlowAssetApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetApplyRejectAudit = <NUDATA extends (keyof AT_FlowAssetApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetApplyDynamicRejectAudit = <NUDATA extends (keyof AT_FlowAssetApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetApplyResetAudit = <NUDATA extends (keyof AT_FlowAssetApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetApplySaveDraft = <NUDATA extends (keyof AT_FlowAssetApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetApplySubmitAudit = <NUDATA extends (keyof AT_FlowAssetApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetApply/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowAssetApplyDeleteAssetApplyByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowAssetApplyGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowAssetApplyGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeAssetDefineAddAssetDefine = <NUDATA extends (keyof AT_AssetDefineModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/AssetDefine/AddAssetDefine?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeAssetDefineDeleteAssetDefine = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/AssetDefine/DeleteAssetDefine?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeAssetDefineGetAssetDefineById = <RNU extends (keyof AT_AssetDefineViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowAssetLedgerAssetLedgerExport = <NUDATA extends (keyof AT_AssetLedgerQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/AssetLedgerExport?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowAssetLedgerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerPendingAudit = <NUDATA extends (keyof AT_FlowAssetLedgerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerRejectAudit = <NUDATA extends (keyof AT_FlowAssetLedgerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerDynamicRejectAudit = <NUDATA extends (keyof AT_FlowAssetLedgerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerResetAudit = <NUDATA extends (keyof AT_FlowAssetLedgerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerSaveDraft = <NUDATA extends (keyof AT_FlowAssetLedgerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerSubmitAudit = <NUDATA extends (keyof AT_FlowAssetLedgerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowAssetLedgerUpdateAssetManageModel = <NUDATA extends (keyof AT_MergeUpdateAssetManageModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/UpdateAssetManageModel?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowAssetLedgerBatchUpdateAssetManage = <NUDATA extends (keyof AT_BatchUpdateAssetManageModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/BatchUpdateAssetManage?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowAssetLedgerDeleteAssetLedgerByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/AssetLedger/DeleteAssetLedgerByFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeflowAssetLedgerBatchSetIsLabel = (isLabel: number, FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowAssetLedgerAssetLessor = (assetLessorCode: string, savePlace: string, FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowAssetLedgerBatchEnterInvoice = <NUDATA extends (keyof AT_BatchEnterInvoice)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetLedger/BatchEnterInvoice?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetLedgerGetAssetLedgerByIds = <RNU extends (keyof AT_GetEnterInvoiceDetails)[] = []>(
	FirmCode: string,
	data: number[]
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowAssetLedgerGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowAssetLedgerGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeAssetLedgerCompanyAddAssetLedgerCompany = <NUDATA extends (keyof AT_AssetCompanyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/AssetLedgerCompany/AddAssetLedgerCompany?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const postFirmCodeAssetLessorAddAssetLessor = <NUDATA extends (keyof AT_AssetLessorModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/AssetLessor/AddAssetLessor?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeAssetLessorUpdateAssetLessor = <NUDATA extends (keyof AT_AssetLessorModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/AssetLessor/UpdateAssetLessor?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeAssetLessorGetAssetLessorById = <RNU extends (keyof AT_AssetLessorModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeAssetLessorGetAssetLessorsByLessor = <RNU extends (keyof AT_AssetLessorViewModel)[] = []>(
	lessor: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowAssetPurchaseDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowAssetPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetPurchasePendingAudit = <NUDATA extends (keyof AT_FlowAssetPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetPurchaseRejectAudit = <NUDATA extends (keyof AT_FlowAssetPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetPurchaseDynamicRejectAudit = <NUDATA extends (keyof AT_FlowAssetPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetPurchaseResetAudit = <NUDATA extends (keyof AT_FlowAssetPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetPurchaseSaveDraft = <NUDATA extends (keyof AT_FlowAssetPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowAssetPurchaseSubmitAudit = <NUDATA extends (keyof AT_FlowAssetPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowAssetPurchaseGetWarehousing = <RNU extends (keyof AT_WarehousingDetailsModel)[] = []>(
	FirmCode: string,
	data: number[]
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowAssetPurchaseWarehousing = <NUDATA extends (keyof AT_WarehousingModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/AssetPurchase/Warehousing?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowAssetPurchaseDeleteAssetPurchase = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/AssetPurchase/DeleteAssetPurchase?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowAssetPurchaseGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowAssetPurchaseGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowBorrowGetBorrowById = <RNU extends (keyof AT_BorrowViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowBorrowGetBorrowByFlowId = <RNU extends (keyof AT_FlowModelBorrowViewModelTuple)[] = []>(
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowBorrowDeleteBorrowFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowBorrowBorrowRepayment = <NUDATA extends (keyof AT_RepaymentRecordModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/BorrowRepayment?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowBorrowInterest = <NUDATA extends (keyof AT_BorrowInterestModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/BorrowInterest?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowBorrowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowPendingAudit = <NUDATA extends (keyof AT_FlowBorrowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowRejectAudit = <NUDATA extends (keyof AT_FlowBorrowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowDynamicRejectAudit = <NUDATA extends (keyof AT_FlowBorrowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowResetAudit = <NUDATA extends (keyof AT_FlowBorrowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowSaveDraft = <NUDATA extends (keyof AT_FlowBorrowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBorrowSubmitAudit = <NUDATA extends (keyof AT_FlowBorrowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Borrow/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowBorrowGetBorrowByUser = <RNU extends (keyof AT_GetBorrowByUserModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowBorrowGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowBorrowGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeBorrowUserSubmitBorrowUser = <NUDATA extends (keyof AT_BorrowUserModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/BorrowUser/SubmitBorrowUser?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeBorrowUserRemoveBorrowUser = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/BorrowUser/RemoveBorrowUser?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeBorrowUserGetBorrowUserById = <RNU extends (keyof AT_BorrowUserModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowBusinessTripDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowBusinessTripModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/BusinessTrip/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBusinessTripPendingAudit = <NUDATA extends (keyof AT_FlowBusinessTripModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/BusinessTrip/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBusinessTripRejectAudit = <NUDATA extends (keyof AT_FlowBusinessTripModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/BusinessTrip/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBusinessTripDynamicRejectAudit = <NUDATA extends (keyof AT_FlowBusinessTripModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/BusinessTrip/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBusinessTripResetAudit = <NUDATA extends (keyof AT_FlowBusinessTripModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/BusinessTrip/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBusinessTripSaveDraft = <NUDATA extends (keyof AT_FlowBusinessTripModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/BusinessTrip/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowBusinessTripSubmitAudit = <NUDATA extends (keyof AT_FlowBusinessTripModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/BusinessTrip/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowBusinessTripDeleteBusinessTripByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/BusinessTrip/DeleteBusinessTripByFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowBusinessTripGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowBusinessTripGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowCancelDepDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowCancelDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelDep/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelDepPendingAudit = <NUDATA extends (keyof AT_FlowCancelDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelDep/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelDepRejectAudit = <NUDATA extends (keyof AT_FlowCancelDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelDep/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelDepDynamicRejectAudit = <NUDATA extends (keyof AT_FlowCancelDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelDep/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelDepSaveDraft = <NUDATA extends (keyof AT_FlowCancelDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelDep/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelDepSubmitAudit = <NUDATA extends (keyof AT_FlowCancelDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelDep/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelDepResetAudit = <NUDATA extends (keyof AT_FlowCancelDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelDep/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowCancelDepGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowCancelDepGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowCancelLevelDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowCancelLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelLevel/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelLevelPendingAudit = <NUDATA extends (keyof AT_FlowCancelLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelLevel/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelLevelRejectAudit = <NUDATA extends (keyof AT_FlowCancelLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelLevel/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelLevelDynamicRejectAudit = <NUDATA extends (keyof AT_FlowCancelLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelLevel/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelLevelSaveDraft = <NUDATA extends (keyof AT_FlowCancelLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelLevel/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelLevelSubmitAudit = <NUDATA extends (keyof AT_FlowCancelLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelLevel/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelLevelResetAudit = <NUDATA extends (keyof AT_FlowCancelLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelLevel/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowCancelLevelGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowCancelLevelGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowCancelPositionDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowCancelPositionModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelPosition/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelPositionPendingAudit = <NUDATA extends (keyof AT_FlowCancelPositionModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelPosition/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelPositionRejectAudit = <NUDATA extends (keyof AT_FlowCancelPositionModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelPosition/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelPositionDynamicRejectAudit = <NUDATA extends (keyof AT_FlowCancelPositionModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelPosition/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelPositionSaveDraft = <NUDATA extends (keyof AT_FlowCancelPositionModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelPosition/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelPositionSubmitAudit = <NUDATA extends (keyof AT_FlowCancelPositionModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelPosition/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCancelPositionResetAudit = <NUDATA extends (keyof AT_FlowCancelPositionModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/CancelPosition/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowCancelPositionGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowCancelPositionGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeCommonSearchAllDepJoint = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchFourLevelByDepCode = <RNU extends (keyof AT_DepNameModel)[] = []>(depCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchStaffInfoByBarCode = <RNU extends (keyof AT_StaffInfo)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchCostType = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(IsEnable: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueIntViewModel, RNU>>>(
		`/${FirmCodeURL}/Common/SearchCostType?${IsEnable ? 'IsEnable=' + IsEnable : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeCommonSearchCostProject = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(IsEnable: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueIntViewModel, RNU>>>(
...
export const getFirmCodeCommonSearchRewardSubject = <RNU extends (keyof AT_RewardSubjectModel)[] = []>(rewardType: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchSocialSecurityCso = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(
	searchText: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchDepByBarCode = <RNU extends (keyof AT_DepNameModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_DepNameModel, RNU>[]>>(
...
export const getFirmCodeCommonSearchStaffInfoByDepCode = <RNU extends (keyof AT_StaffInfo)[] = []>(depCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_StaffInfo, RNU>[]>>(
...
export const getFirmCodeCommonSearchExcludeHouseFundSocialInsuranceSubject = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueIntViewModel, RNU>>>(
...
export const getFirmCodeCommonSearchMaterialType = <RNU extends (keyof AT_MaterialTypeNameModel)[] = []>(isAll: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchPersonalReceipt = <RNU extends (keyof AT_PersonalReceiptSimpleModel)[] = []>(
	barCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonGetInductionDate = (barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchAssetManageState = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(isApply: boolean, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueIntViewModel, RNU>>>(
...
export const postFirmCodeCommonRouteClick = (routeId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeCommonSearchCsoBankBook = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(csoCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueStringViewModel, RNU>>>(
		`/${FirmCodeURL}/Common/SearchCsoBankBook?${csoCode ? 'csoCode=' + csoCode : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeCommonGetFirmCsoBankBook = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(firm: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueStringViewModel, RNU>>>(
		`/${FirmCodeURL}/Common/GetFirmCsoBankBook?${firm ? 'firm=' + firm : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeCommonSearchCsoBankBookByBookName = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(
	bookName: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchDepCodeMatchByDepCode = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(
	depCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeCommonSearchDepCodeMatchByDepCodes = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(
	FirmCode: string,
	data: string[]
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonGetPayBackRecordByMoneyCode = <RNU extends (keyof AT_PayBackRecordModel)[] = []>(
	moneyCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonGetBamsDepCodeByBarCode = <RNU extends (keyof AT_KeyValueStringModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonGetLevelByBarCode = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueStringViewModel, RNU>>>(
		`/${FirmCodeURL}/Common/GetLevelByBarCode?${barCode ? 'barCode=' + barCode : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeCommonCancelFlowlistHomeShow = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeCommonSearchPopupRoute = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(searchText: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueIntViewModel, RNU>>>(
		`/${FirmCodeURL}/Common/SearchPopupRoute?${searchText ? 'searchText=' + searchText : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeCommonSearchPositionByDepCode = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(
	depCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchStaff = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(searchText: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueStringViewModel, RNU>>>(
...
export const getFirmCodeCommonSearchAllCityByProvince = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(
	provinceid: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchAllCountyByCity = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(cityId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueIntViewModel, RNU>>>(
...
export const getFirmCodeCommonGetUserDepPost = <RNU extends (keyof AT_DepPost)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchContractTypeByText = <RNU extends (keyof AT_KeyValueIntViewModel)[] = []>(text: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueIntViewModel, RNU>>>(
...
export const getFirmCodeCommonSearchStaffBankByBarCode = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(
	barCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonSearchCsoByCosName = <RNU extends (keyof AT_KeyValueStringViewModel)[] = []>(csoName: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_KeyValueStringViewModel, RNU>>>(
		`/${FirmCodeURL}/Common/SearchCsoByCosName?${csoName ? 'csoName=' + csoName : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeCommonGetFamilyInfoById = <RNU extends (keyof AT_FamilyInfoModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCommonGetFirmBySchemeCode = <RNU extends (keyof AT_FirmSimpleModel)[] = []>(schemeCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeContractAddContract = <NUDATA extends (keyof AT_ContractModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Contract/AddContract?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeContractContractHandle = (contractId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/Contract/ContractHandle?${contractId ? 'contractId=' + contractId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeContractRemoveContract = (contractId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/Contract/RemoveContract?${contractId ? 'contractId=' + contractId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeContractGetContractById = <RNU extends (keyof AT_ContractViewModel)[] = []>(contractId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeContractGetHistoryContract = <RNU extends (keyof AT_ContractPageModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeContractTypeSubmitContractType = <NUDATA extends (keyof AT_ContractTypeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/ContractType/SubmitContractType?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeContractTypeGetContractTypeById = <RNU extends (keyof AT_ContractTypeModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeContractTypeDeleteContractType = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/ContractType/DeleteContractType?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowCostGetCostById = <RNU extends (keyof AT_CostViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowCostDeleteCostFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Cost/DeleteCostFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowCostGetCostByFlowId = <RNU extends (keyof AT_FlowModelCostViewModelTuple)[] = []>(flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowCostDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Cost/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCostPendingAudit = <NUDATA extends (keyof AT_FlowCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Cost/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCostRejectAudit = <NUDATA extends (keyof AT_FlowCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Cost/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCostDynamicRejectAudit = <NUDATA extends (keyof AT_FlowCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Cost/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCostResetAudit = <NUDATA extends (keyof AT_FlowCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Cost/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCostSaveDraft = <NUDATA extends (keyof AT_FlowCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Cost/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowCostSubmitAudit = <NUDATA extends (keyof AT_FlowCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Cost/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowCostGetCostByUser = <RNU extends (keyof AT_GetCostByUserModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowCostGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowCostGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeCostInvoiceBatchCostInvoice = <NUDATA extends (keyof AT_CostInvoiceQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostInvoice/BatchCostInvoice?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeCostInvoiceAddCostInvoice = <NUDATA extends (keyof AT_CostInvoiceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostInvoice/AddCostInvoice?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeCostInvoiceBatchConfirm = (FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostInvoice/BatchConfirm?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeCostInvoiceGetCostInvoiceById = <RNU extends (keyof AT_CostInvoiceViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeCostInvoiceSummaryBatchZeroClean = <NUDATA extends (keyof AT_ZeroClean)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostInvoiceSummary/BatchZeroClean?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeCostInvoiceSummaryBatchCostInvoiceSummary = <NUDATA extends (keyof AT_CostInvoiceSummaryQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/CostInvoiceSummary/BatchCostInvoiceSummary?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeCostInvoiceSummaryUpdateCostInvoiceCompany = <NUDATA extends (keyof AT_UpdateCostInvoiceCompanyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/CostInvoiceSummary/UpdateCostInvoiceCompany?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeCostProjectAddCostProject = <NUDATA extends (keyof AT_CostProjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostProject/AddCostProject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeCostProjectUpdateCostProject = <NUDATA extends (keyof AT_CostProjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostProject/UpdateCostProject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeCostProjectGetCostProjectById = <RNU extends (keyof AT_CostProjectModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeCostSubjectSubmitCostSubject = <NUDATA extends (keyof AT_CostSubjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostSubject/SubmitCostSubject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeCostSubjectGetCostSubjectById = <RNU extends (keyof AT_CostSubjectModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeCostTypeSubmitCostType = <NUDATA extends (keyof AT_CostTypeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/CostType/SubmitCostType?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeCostTypeGetCostTypeById = <RNU extends (keyof AT_CostTypeModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeCsoGetStaffListByCsoCode = (csoCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<string[]>>(
		`/${FirmCodeURL}/Cso/GetStaffListByCsoCode?${csoCode ? 'csoCode=' + csoCode : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeCsoAddCso = <NUDATA extends (keyof AT_CsoModel)[] = []>(FirmCode: string, data: U_I_NoNull<AT_CsoModel, NUDATA>) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Cso/AddCso?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeCsoUpdateCso = <NUDATA extends (keyof AT_CsoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Cso/UpdateCso?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeCsoGetCsoById = <RNU extends (keyof AT_CsoViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeDailylogSaveDailyLog = <NUDATA extends (keyof AT_DailyLogRequestModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Dailylog/SaveDailyLog?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeDailylogDeleteDailyLog = (dailyLogId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeDailylogSaveDailyLogComment = <NUDATA extends (keyof AT_DailyLogRequsetComment)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Dailylog/SaveDailyLogComment?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeDailylogDeleteDailyLogComment = (dailyLogCommentId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<boolean>>(
...
export const postFirmCodeDailylogDailyLogShare = <NUDATA extends (keyof AT_DailylogRequestShare)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Dailylog/DailyLogShare?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeDailylogDailyLogPraise = (dailyLogId: number, isPraise: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeDailylogDailyLogKeep = (dailyLogId: number, isKeep: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<number>>(
...
export const getFirmCodeDailylogDailyLogRead = (dailyLogId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<boolean>>(
		`/${FirmCodeURL}/Dailylog/DailyLogRead?${dailyLogId ? 'dailyLogId=' + dailyLogId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeDailylogGetDailyLogReadUser = (dailyLogId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<string[]>>(
...
export const getFirmCodeDailylogGetDailyLogInfoById = <RNU extends (keyof AT_DailyLogViewModel)[] = []>(dailyLogId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowDepDynamicRejectAudit = <NUDATA extends (keyof AT_FlowDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Dep/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowDepDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Dep/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowDepGetDepByFlowId = <RNU extends (keyof AT_FlowModelDepViewModelTuple)[] = []>(flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModelDepViewModelTuple, RNU>>>(
...
export const getFirmCodeflowDepGetDepTreeListByDepCode = <RNU extends (keyof AT_DepTreeListMole)[] = []>(depCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_DepTreeListMole, RNU>>>(
...
export const postFirmCodeflowDepPendingAudit = <NUDATA extends (keyof AT_FlowDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Dep/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowDepRejectAudit = <NUDATA extends (keyof AT_FlowDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Dep/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowDepSaveDraft = <NUDATA extends (keyof AT_FlowDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Dep/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowDepSubmitAudit = <NUDATA extends (keyof AT_FlowDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Dep/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowDepRenewalDepFatherData = (password: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Dep/RenewalDepFatherData?${password ? 'password=' + password : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeflowDepDeleteDepByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowDepUpdateDepSort = <NUDATA extends (keyof AT_UpdateDepSort)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Dep/UpdateDepSort?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowDepGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowDepGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeDepSpecialAddDepSpecial = <NUDATA extends (keyof AT_DepSpecialAddModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/DepSpecial/AddDepSpecial?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeDepSpecialDeleteDepSpecial = (vestCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/DepSpecial/DeleteDepSpecial?${vestCode ? 'vestCode=' + vestCode : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeDepSpecialGetDepSpecialByUser = (vestCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<string[]>>(
...
export const getFirmCodeflowEmployGetEmployApproveById = <RNU extends (keyof AT_EmployViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowEmployDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowEmployApproveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Employ/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowEmployPendingAudit = <NUDATA extends (keyof AT_FlowEmployApproveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Employ/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowEmployRejectAudit = <NUDATA extends (keyof AT_FlowEmployApproveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Employ/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowEmployDynamicRejectAudit = <NUDATA extends (keyof AT_FlowEmployApproveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Employ/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowEmployResetAudit = <NUDATA extends (keyof AT_FlowEmployApproveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Employ/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowEmploySaveDraft = <NUDATA extends (keyof AT_FlowEmployApproveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Employ/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowEmploySubmitAudit = <NUDATA extends (keyof AT_FlowEmployApproveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Employ/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowEmployDeleteEmploy = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Employ/DeleteEmploy?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowEmployGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowEmployGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const getFirmCodeEntryManageGetEntryManageById = <RNU extends (keyof AT_EntryManageViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeEntryManageToPersonnel = (
	id: number,
	popupKey: string,
...
export const postFirmCodeEntryManageUnemployed = <NUDATA extends (keyof AT_UnemployedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/EntryManage/Unemployed?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeEntryManageConfirmEnrollment = <NUDATA extends (keyof AT_ConfirmEnrollmentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/EntryManage/ConfirmEnrollment?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeFaceTalkSubmitFaceTalk = <NUDATA extends (keyof AT_FaceTalkModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/FaceTalk/SubmitFaceTalk?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeFaceTalkGetFaceTalkById = <RNU extends (keyof AT_FaceTalkViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeFirmGetFirmInfo = <RNU extends (keyof AT_FirmModel)[] = []>(fmCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeFirmGetFirmDepChecker = <RNU extends (keyof AT_FirmDepCheckerModel)[] = []>(fmCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeFirmUpdateFirm = <NUDATA extends (keyof AT_FirmModel)[] = []>(FirmCode: string, data: U_I_NoNull<AT_FirmModel, NUDATA>) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Firm/UpdateFirm?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeFirmAdminiBindAccountToStaff = <NUDATA extends (keyof AT_AccountToStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/FirmAdmini/BindAccountToStaff?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeFirmAdminiUnBindAccountToStaff = (barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeFirmAdminiGetAccountManager = <RNU extends (keyof AT_AccountManagerModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowFlowBaseApiGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowFlowBaseApiGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeFlowManagerMergeFlowType = <NUDATA extends (keyof AT_FlowTypeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/FlowManager/MergeFlowType?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeFlowManagerRemoveFlowType = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeFlowManagerGetFlowTypeInfo = <RNU extends (keyof AT_FlowTypeInfoModel)[] = []>(flowTypeId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeHelpNotesGetHelpNotesByComponent = <RNU extends (keyof AT_HelpNotesViewModel)[] = []>(
	component: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeHelpNotesAddOrUpdateHelpNotes = <NUDATA extends (keyof AT_HelpNotesModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/HelpNotes/AddOrUpdateHelpNotes?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeHolidayAddUpdateHoliday = <NUDATA extends (keyof AT_HolidayModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Holiday/AddUpdateHoliday?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeHolidayGetHolidayById = <RNU extends (keyof AT_HolidayViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeHomePageRollPicDeleteHomePageRollPic = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeHomePageRollPicUpdateHomePageRollPic = <NUDATA extends (keyof AT_UpDateHomePageRollPicModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/HomePageRollPic/UpdateHomePageRollPic?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeHotelAddHotel = <NUDATA extends (keyof AT_HotelModel)[] = []>(FirmCode: string, data: U_I_NoNull<AT_HotelModel, NUDATA>) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Hotel/AddHotel?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeHotelUpdateHotel = <NUDATA extends (keyof AT_HotelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/Hotel/UpdateHotel?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeHotelRemoveHotel = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Hotel/RemoveHotel?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`);
};
export const getFirmCodeHotelGetHotelById = <RNU extends (keyof AT_HotelViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeHotelBatchExportHotel = <NUDATA extends (keyof AT_HotelQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Hotel/BatchExportHotel?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowInternshipUpUpdateTryoutPost = <NUDATA extends (keyof AT_TryoutPostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/UpdateTryoutPost?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowInternshipUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpPendingAudit = <NUDATA extends (keyof AT_FlowInternshipUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpRejectAudit = <NUDATA extends (keyof AT_FlowInternshipUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpDynamicRejectAudit = <NUDATA extends (keyof AT_FlowInternshipUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpResetAudit = <NUDATA extends (keyof AT_FlowInternshipUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpSaveDraft = <NUDATA extends (keyof AT_FlowInternshipUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpSubmitAudit = <NUDATA extends (keyof AT_FlowInternshipUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/InternshipUp/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowInternshipUpDeleteInternshipUp = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/InternshipUp/DeleteInternshipUp?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowInternshipUpGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowInternshipUpGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeInterviewEvaluateMergeInterviewEvaluate = <NUDATA extends (keyof AT_InterviewEvaluateModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/InterviewEvaluate/MergeInterviewEvaluate?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const getFirmCodeInterviewManegeGetInterviewById = <RNU extends (keyof AT_InterviewViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeInterviewManegeGetInterviewResultById = <RNU extends (keyof AT_InterviewResultViewModel)[] = []>(
	id: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeInterviewManegeInterviewResult = <NUDATA extends (keyof AT_InterviewResultModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/InterviewManege/InterviewResult?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeInterviewManegeGetBackToTheById = <RNU extends (keyof AT_BackToTheViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeInterviewManegeBackToThe = <NUDATA extends (keyof AT_BackToTheModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/InterviewManege/BackToThe?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeInterviewManegeRefuseEmploy = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeInterviewPlanMergeInterviewPlan = <NUDATA extends (keyof AT_MergeInterviewPlanModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/InterviewPlan/MergeInterviewPlan?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowLeaveGetLeaveByUser = <RNU extends (keyof AT_GetLeaveByUserModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowLeaveDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowLeaveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Leave/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeavePendingAudit = <NUDATA extends (keyof AT_FlowLeaveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Leave/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveRejectAudit = <NUDATA extends (keyof AT_FlowLeaveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Leave/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveDynamicRejectAudit = <NUDATA extends (keyof AT_FlowLeaveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Leave/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveResetAudit = <NUDATA extends (keyof AT_FlowLeaveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Leave/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveSaveDraft = <NUDATA extends (keyof AT_FlowLeaveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Leave/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveSubmitAudit = <NUDATA extends (keyof AT_FlowLeaveModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Leave/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowLeaveGetLeaveByFlowId = <RNU extends (keyof AT_FlowModelLeaveViewModelTuple)[] = []>(
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowLeaveGetLeaveById = <RNU extends (keyof AT_LeaveViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowLeaveSearchStaffInfoByDepCode = <RNU extends (keyof AT_StaffInfo)[] = []>(
	barCode: string,
	depCode: string,
	FirmCode: string
) => {
...
export const getFirmCodeflowLeaveGetCumulativeTimeout = (barCode: string, holidayId: number, duration: number, year: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<number>>(
...
export const getFirmCodeflowLeaveGetLeaveDuration = (holidayId: number, startTime: string, endTime: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<number>>(
...
export const postFirmCodeflowLeaveDeleteLeaveByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Leave/DeleteLeaveByFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowLeaveGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowLeaveGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeflowLeaveDestroyDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowLeaveDestroyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LeaveDestroy/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveDestroyPendingAudit = <NUDATA extends (keyof AT_FlowLeaveDestroyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LeaveDestroy/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveDestroyRejectAudit = <NUDATA extends (keyof AT_FlowLeaveDestroyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LeaveDestroy/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveDestroyDynamicRejectAudit = <NUDATA extends (keyof AT_FlowLeaveDestroyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LeaveDestroy/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveDestroyResetAudit = <NUDATA extends (keyof AT_FlowLeaveDestroyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LeaveDestroy/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveDestroySaveDraft = <NUDATA extends (keyof AT_FlowLeaveDestroyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LeaveDestroy/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLeaveDestroySubmitAudit = <NUDATA extends (keyof AT_FlowLeaveDestroyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LeaveDestroy/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowLeaveDestroyDeleteLeaveDestroyByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/LeaveDestroy/DeleteLeaveDestroyByFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowLeaveDestroyGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowLeaveDestroyGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowLevelGetLevelByFlowId = <RNU extends (keyof AT_FlowModelLevelViewModelTuple)[] = []>(
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowLevelDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Level/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelPendingAudit = <NUDATA extends (keyof AT_FlowLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Level/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelRejectAudit = <NUDATA extends (keyof AT_FlowLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Level/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelDynamicRejectAudit = <NUDATA extends (keyof AT_FlowLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Level/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelSaveDraft = <NUDATA extends (keyof AT_FlowLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Level/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelSubmitAudit = <NUDATA extends (keyof AT_FlowLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Level/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelResetAudit = <NUDATA extends (keyof AT_FlowLevelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Level/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowLevelGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowLevelGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeflowLevelResetFlowDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowLevelResetFlowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LevelResetFlow/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelResetFlowPendingAudit = <NUDATA extends (keyof AT_FlowLevelResetFlowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LevelResetFlow/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelResetFlowRejectAudit = <NUDATA extends (keyof AT_FlowLevelResetFlowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LevelResetFlow/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelResetFlowDynamicRejectAudit = <NUDATA extends (keyof AT_FlowLevelResetFlowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LevelResetFlow/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelResetFlowResetAudit = <NUDATA extends (keyof AT_FlowLevelResetFlowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LevelResetFlow/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelResetFlowSaveDraft = <NUDATA extends (keyof AT_FlowLevelResetFlowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LevelResetFlow/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowLevelResetFlowSubmitAudit = <NUDATA extends (keyof AT_FlowLevelResetFlowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/LevelResetFlow/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowLevelResetFlowDeleteLevelResetFlow = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/LevelResetFlow/DeleteLevelResetFlow?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowLevelResetFlowGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowLevelResetFlowGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeMasterCardBagSaveMasterCardBag = <NUDATA extends (keyof AT_MasterCardBagModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/MasterCardBag/SaveMasterCardBag?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeMasterCardBagGetMasterCardBagById = <RNU extends (keyof AT_MasterCardBagModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowMasterCardRechargeApplyPendingAudit = <NUDATA extends (keyof AT_FlowMasterCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MasterCardRechargeApply/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowMasterCardRechargeApplyRejectAudit = <NUDATA extends (keyof AT_FlowMasterCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MasterCardRechargeApply/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const postFirmCodeflowMasterCardRechargeApplyResetAudit = <NUDATA extends (keyof AT_FlowMasterCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MasterCardRechargeApply/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMasterCardRechargeApplySaveDraft = <NUDATA extends (keyof AT_FlowMasterCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MasterCardRechargeApply/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMasterCardRechargeApplySubmitAudit = <NUDATA extends (keyof AT_FlowMasterCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MasterCardRechargeApply/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const postFirmCodeflowMasterCardRechargeApplyDeleteMasterCardRechargeApply = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeMaterialGetMaterialById = <RNU extends (keyof AT_MaterialViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeMaterialSubmitMaterial = <NUDATA extends (keyof AT_MaterialModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Material/SubmitMaterial?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowMaterialAllocationDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MaterialAllocation/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowMaterialAllocationPendingAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialAllocation/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialAllocationRejectAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialAllocation/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialAllocationDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MaterialAllocation/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowMaterialAllocationResetAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialAllocation/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialAllocationSaveDraft = <NUDATA extends (keyof AT_FlowMaterialAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialAllocation/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialAllocationSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialAllocation/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMaterialAllocationGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowMaterialAllocationGrantPendingAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MaterialAllocationGrant/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowMaterialAllocationGrantRejectAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MaterialAllocationGrant/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const postFirmCodeflowMaterialAllocationGrantResetAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialAllocationGrant/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialAllocationGrantSaveDraft = <NUDATA extends (keyof AT_FlowMaterialAllocationGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialAllocationGrant/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialAllocationGrantSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialAllocationGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MaterialAllocationGrant/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const getFirmCodeflowMaterialApplyGetMaterialApplyById = <RNU extends (keyof AT_MaterialApplyViewModel)[] = []>(
	id: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowMaterialApplyDeleteMaterialApplyByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowMaterialApplyMaterialApplyCancel = <NUDATA extends (keyof AT_MaterialApplyCancelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/MaterialApplyCancel?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialApplyDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialApplyPendingAudit = <NUDATA extends (keyof AT_FlowMaterialApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialApplyRejectAudit = <NUDATA extends (keyof AT_FlowMaterialApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialApplyDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMaterialApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialApplyResetAudit = <NUDATA extends (keyof AT_FlowMaterialApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialApplySaveDraft = <NUDATA extends (keyof AT_FlowMaterialApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialApplySubmitAudit = <NUDATA extends (keyof AT_FlowMaterialApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialApply/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMaterialApplyGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowMaterialApplyGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowMaterialCheckDeleteMaterialCheckByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowMaterialCheckDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialCheckModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialCheck/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialCheckPendingAudit = <NUDATA extends (keyof AT_FlowMaterialCheckModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialCheck/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialCheckRejectAudit = <NUDATA extends (keyof AT_FlowMaterialCheckModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialCheck/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialCheckDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMaterialCheckModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialCheck/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialCheckResetAudit = <NUDATA extends (keyof AT_FlowMaterialCheckModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialCheck/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialCheckSaveDraft = <NUDATA extends (keyof AT_FlowMaterialCheckModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialCheck/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialCheckSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialCheckModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialCheck/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMaterialCheckGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowMaterialCheckGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowMaterialGrantDeleteMaterialGrantByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowMaterialGrantDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialGrantPendingAudit = <NUDATA extends (keyof AT_FlowMaterialGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialGrantRejectAudit = <NUDATA extends (keyof AT_FlowMaterialGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialGrantDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMaterialGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialGrantResetAudit = <NUDATA extends (keyof AT_FlowMaterialGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialGrantSaveDraft = <NUDATA extends (keyof AT_FlowMaterialGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialGrantSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialGrantModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowMaterialGrantBatchMaterialGrant = <NUDATA extends (keyof AT_MaterialGrantQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialGrant/BatchMaterialGrant?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMaterialGrantGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowMaterialGrantGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowMaterialNeedDeleteMaterialNeedByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowMaterialNeedDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialNeedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialNeed/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialNeedPendingAudit = <NUDATA extends (keyof AT_FlowMaterialNeedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialNeed/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialNeedRejectAudit = <NUDATA extends (keyof AT_FlowMaterialNeedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialNeed/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialNeedDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMaterialNeedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialNeed/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialNeedResetAudit = <NUDATA extends (keyof AT_FlowMaterialNeedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialNeed/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialNeedSaveDraft = <NUDATA extends (keyof AT_FlowMaterialNeedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialNeed/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialNeedSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialNeedModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialNeed/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMaterialNeedGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowMaterialNeedGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowMaterialPurchaseDeleteMaterialPurchaseByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowMaterialPurchaseDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MaterialPurchase/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowMaterialPurchasePendingAudit = <NUDATA extends (keyof AT_FlowMaterialPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialPurchase/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialPurchaseRejectAudit = <NUDATA extends (keyof AT_FlowMaterialPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialPurchase/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialPurchaseDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMaterialPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/MaterialPurchase/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowMaterialPurchaseResetAudit = <NUDATA extends (keyof AT_FlowMaterialPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialPurchase/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialPurchaseSaveDraft = <NUDATA extends (keyof AT_FlowMaterialPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialPurchase/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialPurchaseSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialPurchaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialPurchase/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMaterialPurchaseGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeMaterialPurposeSubmitMaterialPurpose = <NUDATA extends (keyof AT_MaterialPurposeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/MaterialPurpose/SubmitMaterialPurpose?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeMaterialPurposeGetMaterialPurposeById = <RNU extends (keyof AT_MaterialPurposeModel)[] = []>(
	id: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowMaterialReturnDeleteMaterialReturnByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowMaterialReturnDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialReturn/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialReturnPendingAudit = <NUDATA extends (keyof AT_FlowMaterialReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialReturn/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialReturnRejectAudit = <NUDATA extends (keyof AT_FlowMaterialReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialReturn/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialReturnDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMaterialReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialReturn/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialReturnResetAudit = <NUDATA extends (keyof AT_FlowMaterialReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialReturn/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialReturnSaveDraft = <NUDATA extends (keyof AT_FlowMaterialReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialReturn/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMaterialReturnSubmitAudit = <NUDATA extends (keyof AT_FlowMaterialReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/MaterialReturn/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMaterialReturnGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowMaterialReturnGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeMaterialSupplierSubmitMaterialSupplier = <NUDATA extends (keyof AT_MaterialSupplierModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/MaterialSupplier/SubmitMaterialSupplier?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeMaterialTypeSubmitMaterialType = <NUDATA extends (keyof AT_MaterialTypeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/MaterialType/SubmitMaterialType?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeMaterialTypeGetMaterialTypeById = <RNU extends (keyof AT_MaterialTypeModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowMeetGetMeetByFlowId = <RNU extends (keyof AT_FlowModelMeetViewModelTuple)[] = []>(flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowMeetDeleteMeetFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowMeetMeetFollow = <NUDATA extends (keyof AT_MeetFollowModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/MeetFollow?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetMeetCancel = <NUDATA extends (keyof AT_MeetCancelModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/MeetCancel?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowMeetModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetPendingAudit = <NUDATA extends (keyof AT_FlowMeetModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetRejectAudit = <NUDATA extends (keyof AT_FlowMeetModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetDynamicRejectAudit = <NUDATA extends (keyof AT_FlowMeetModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetSaveDraft = <NUDATA extends (keyof AT_FlowMeetModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetSubmitAudit = <NUDATA extends (keyof AT_FlowMeetModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowMeetResetAudit = <NUDATA extends (keyof AT_FlowMeetModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Meet/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowMeetGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowMeetGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const getFirmCodeMeetRoomGetMeetRoomById = <RNU extends (keyof AT_MeetViewRoomModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_MeetViewRoomModel, RNU>>>(
...
export const postFirmCodeMeetRoomSubmitMeetRoom = <NUDATA extends (keyof AT_MeetRoomModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/MeetRoom/SubmitMeetRoom?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeNewsletterAddNewsletter = <NUDATA extends (keyof AT_NewsletterModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Newsletter/AddNewsletter?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeNewsletterRemoveNewsletter = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/Newsletter/RemoveNewsletter?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeNewsletterGetNewsletterById = <RNU extends (keyof AT_NewsletterViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowNoticeDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticePendingAudit = <NUDATA extends (keyof AT_FlowNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticeRejectAudit = <NUDATA extends (keyof AT_FlowNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticeDynamicRejectAudit = <NUDATA extends (keyof AT_FlowNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticeResetAudit = <NUDATA extends (keyof AT_FlowNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticeSaveDraft = <NUDATA extends (keyof AT_FlowNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticeSubmitAudit = <NUDATA extends (keyof AT_FlowNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowNoticeGetNoticeByFlowId = <RNU extends (keyof AT_FlowModelNoticesViewModelTuple)[] = []>(
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowNoticeSaveNotice = <NUDATA extends (keyof AT_SaveNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/SaveNotice?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticePublishNotice = <NUDATA extends (keyof AT_SaveNoticeModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Notice/PublishNotice?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowNoticeDeleteNotice = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Notice/DeleteNotice?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowNoticeGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowNoticeGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeOfficeSuppliesBasisGetOfficeSuppliesBasisToPage = <
	RNU extends (keyof AT_OfficeSuppliesBasisPageModelIEnumerableInt32Tuple)[] = [],
	NUDATA extends (keyof AT_OfficeSuppliesBasisQueryModel)[] = [],
>(
	FirmCode: string,
	...
	return axios.post<ResponseData<U_I_NoNull<AT_OfficeSuppliesBasisPageModelIEnumerableInt32Tuple, RNU>>>(
		`/${FirmCodeURL}/OfficeSuppliesBasis/GetOfficeSuppliesBasisToPage?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const postFirmCodeOfficeSuppliesBasisMergeOfficeSuppliesClass = <NUDATA extends (keyof AT_OfficeSuppliesClassModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_OfficeSuppliesClassModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/OfficeSuppliesBasis/MergeOfficeSuppliesClass?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeOfficeSuppliesBasisMoveOfficeSuppliesClass = <NUDATA extends (keyof AT_OfficeSuppliesClassMoveModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_OfficeSuppliesClassMoveModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/OfficeSuppliesBasis/MoveOfficeSuppliesClass?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeOfficeSuppliesBasisDeleteOfficeSuppliesClass = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/OfficeSuppliesBasis/DeleteOfficeSuppliesClass?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeOfficeSuppliesBasisMergeOfficeSuppliesBasis = <NUDATA extends (keyof AT_OfficeSuppliesBasisModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_OfficeSuppliesBasisModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/OfficeSuppliesBasis/MergeOfficeSuppliesBasis?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeOfficeSuppliesBasisGetOfficeSuppliesBasisbyId = <RNU extends (keyof AT_OfficeSuppliesBasisViewModel)[] = []>(
	id: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeOfficeSuppliesInventoryGetSummaryOfficeSuppliesInventoryToPage = <
	RNU extends (keyof AT_SummaryOfficeSuppliesInventoryPageModelIEnumerableInt32Tuple)[] = [],
	NUDATA extends (keyof AT_SummaryOfficeSuppliesInventoryQueryModel)[] = [],
>(
	FirmCode: string,
	...
	return axios.post<ResponseData<U_I_NoNull<AT_SummaryOfficeSuppliesInventoryPageModelIEnumerableInt32Tuple, RNU>>>(
		`/${FirmCodeURL}/OfficeSuppliesInventory/GetSummaryOfficeSuppliesInventoryToPage?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeOfficeSuppliesInventoryGetFlowOfficeSuppliesInventoryToPage = <
	RNU extends (keyof AT_FlowOfficeSuppliesInventoryPageModelIEnumerableInt32Tuple)[] = [],
	NUDATA extends (keyof AT_FlowOfficeSuppliesInventoryQueryModel)[] = [],
>(
	FirmCode: string,
	...
	return axios.post<ResponseData<U_I_NoNull<AT_FlowOfficeSuppliesInventoryPageModelIEnumerableInt32Tuple, RNU>>>(
		`/${FirmCodeURL}/OfficeSuppliesInventory/GetFlowOfficeSuppliesInventoryToPage?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowOfficeSuppliesPurchaseGetOfficeSuppliesPurchaseToPage = <
	RNU extends (keyof AT_OfficeSuppliesPurchasePageModelIEnumerableInt32Tuple)[] = [],
	NUDATA extends (keyof AT_OfficeSuppliesPurchaseQueryModel)[] = [],
>(
	FirmCode: string,
	...
	return axios.post<ResponseData<U_I_NoNull<AT_OfficeSuppliesPurchasePageModelIEnumerableInt32Tuple, RNU>>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/GetOfficeSuppliesPurchaseToPage?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowOfficeSuppliesPurchaseDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowOfficeSuppliesPurchaseModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_FlowOfficeSuppliesPurchaseModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowOfficeSuppliesPurchasePendingAudit = <NUDATA extends (keyof AT_FlowOfficeSuppliesPurchaseModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_FlowOfficeSuppliesPurchaseModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowOfficeSuppliesPurchaseRejectAudit = <NUDATA extends (keyof AT_FlowOfficeSuppliesPurchaseModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_FlowOfficeSuppliesPurchaseModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowOfficeSuppliesPurchaseDynamicRejectAudit = <NUDATA extends (keyof AT_FlowOfficeSuppliesPurchaseModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_FlowOfficeSuppliesPurchaseModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowOfficeSuppliesPurchaseResetAudit = <NUDATA extends (keyof AT_FlowOfficeSuppliesPurchaseModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_FlowOfficeSuppliesPurchaseModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowOfficeSuppliesPurchaseSaveDraft = <NUDATA extends (keyof AT_FlowOfficeSuppliesPurchaseModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_FlowOfficeSuppliesPurchaseModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowOfficeSuppliesPurchaseSubmitAudit = <NUDATA extends (keyof AT_FlowOfficeSuppliesPurchaseModel)[] = []>(
	FirmCode: string,
	data: U_I_NoNull<AT_FlowOfficeSuppliesPurchaseModel, NUDATA>
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowOfficeSuppliesPurchaseGetOfficeSuppliesPurchaseByFlowId = <
	RNU extends (keyof AT_FlowModelOfficeSuppliesPurchaseViewModelTuple)[] = [],
>(
	flowId: number,
	FirmCode: string
) => {
	...
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModelOfficeSuppliesPurchaseViewModelTuple, RNU>>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/GetOfficeSuppliesPurchaseByFlowId?${flowId ? 'flowId=' + flowId : ''}&${
			FirmCode ? 'FirmCode=' + FirmCode : ''
		}`
	);
};
export const postFirmCodeflowOfficeSuppliesPurchaseOfficeSuppliesWarehousing = <
	NUDATA extends (keyof AT_OfficeSuppliesPurchaseIntoStockModel)[] = [],
>(
	FirmCode: string,
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/OfficeSuppliesWarehousing?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const getFirmCodeflowOfficeSuppliesPurchaseGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/GetFlowInfo?${popupKey ? 'popupKey=' + popupKey : ''}&${flowId ? 'flowId=' + flowId : ''}&${
			FirmCode ? 'FirmCode=' + FirmCode : ''
		}`
	);
};
export const getFirmCodeflowOfficeSuppliesPurchaseGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
		`/${FirmCodeURL}/flow/OfficeSuppliesPurchase/GetFlowChat?${popupKey ? 'popupKey=' + popupKey : ''}&${flowId ? 'flowId=' + flowId : ''}&${
			FirmCode ? 'FirmCode=' + FirmCode : ''
		}`
	);
};
...
export const postFirmCodePersonalIncomeTaxSavePersonalIncomeTax = <NUDATA extends (keyof AT_PersonalIncomeTaxModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/PersonalIncomeTax/SavePersonalIncomeTax?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodePersonalIncomeTaxDeletePersonalIncomeTax = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodePersonalReceiptAddPersonalReceipt = <NUDATA extends (keyof AT_PersonalModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/PersonalReceipt/AddPersonalReceipt?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodePersonalReceiptRemovePersonalReceipt = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodePersonSalaryRecordCheckSalaryCypher = (passWord: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/PersonSalaryRecord/CheckSalaryCypher?${passWord ? 'passWord=' + passWord : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodePersonSalaryRecordUpdateSalaryCypher = (idCard: string, newPassWord: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodePersonSalaryRecordCheckSalaryCypherIsExist = (FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/PersonSalaryRecord/CheckSalaryCypherIsExist?${FirmCode ? 'FirmCode=' + FirmCode : ''}`);
};
export const postFirmCodePersonSalaryRecordAddSalaryCypher = (passWord: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/PersonSalaryRecord/AddSalaryCypher?${passWord ? 'passWord=' + passWord : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodePopupGetPopup = <RNU extends (keyof AT_PopupViewModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodePopupGetBirthdayPopup = <RNU extends (keyof AT_PopupViewModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_PopupViewModel, RNU>>>(
...
export const postFirmCodePopupPopupRead = <NUDATA extends (keyof AT_PopupReadModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Popup/PopupRead?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowPositionGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowPositionGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeProvidentFundAddProvidentFund = <NUDATA extends (keyof AT_ProvidentFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/ProvidentFund/AddProvidentFund?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeProvidentFundUpdateProvidentFundState = (id: number, state: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeProvidentFundBatchUpdateProvidentFundState = (state: number, FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeProvidentFundGetProvidentFundById = <RNU extends (keyof AT_ProvidentFundViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeRecruitCommissionerSaveRecruitCommissioner = <NUDATA extends (keyof AT_RecruitCommissionerModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/RecruitCommissioner/SaveRecruitCommissioner?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const postFirmCodeRecruitCommissionerDeleteRecruitCommissioner = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeflowRecruitmentGetRecruitmentById = <RNU extends (keyof AT_RecruitViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowRecruitmentDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowRecruitmentDemandModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentPendingAudit = <NUDATA extends (keyof AT_FlowRecruitmentDemandModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentRejectAudit = <NUDATA extends (keyof AT_FlowRecruitmentDemandModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentDynamicRejectAudit = <NUDATA extends (keyof AT_FlowRecruitmentDemandModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentResetAudit = <NUDATA extends (keyof AT_FlowRecruitmentDemandModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentSaveDraft = <NUDATA extends (keyof AT_FlowRecruitmentDemandModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentSubmitAudit = <NUDATA extends (keyof AT_FlowRecruitmentDemandModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentInitiateRecruitment = (flowId: number, commissioner: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRecruitmentImplementCompleted = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRecruitmentCheckRecruitmentDemandByDepCodePostCode = (depCode: string, postCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRecruitmentCompleteRecruitmentByDepCodePostCode = (depCode: string, postCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRecruitmentDeleteRecruiMent = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRecruitmentStopRecruit = <NUDATA extends (keyof AT_StopRecruitModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Recruitment/StopRecruit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRecruitmentContinueRecruit = (recruitId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Recruitment/ContinueRecruit?${recruitId ? 'recruitId=' + recruitId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowRecruitmentGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowRecruitmentGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowRegulationDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationPendingAudit = <NUDATA extends (keyof AT_FlowRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationRejectAudit = <NUDATA extends (keyof AT_FlowRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationDynamicRejectAudit = <NUDATA extends (keyof AT_FlowRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationResetAudit = <NUDATA extends (keyof AT_FlowRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationSaveDraft = <NUDATA extends (keyof AT_FlowRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationSubmitAudit = <NUDATA extends (keyof AT_FlowRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowRegulationSaveRegulation = <NUDATA extends (keyof AT_SaveRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/SaveRegulation?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationPublishRegulation = <NUDATA extends (keyof AT_SaveRegulationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Regulation/PublishRegulation?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRegulationChangeIsPublic = (id: number, isPublic: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRegulationDeleteRegulation = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Regulation/DeleteRegulation?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowRegulationGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowRegulationGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowRentGetRentByFlowId = <RNU extends (keyof AT_FlowModelRentViewModelTuple)[] = []>(flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowRentDeleteRentFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRentDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowRentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Rent/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentPendingAudit = <NUDATA extends (keyof AT_FlowRentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Rent/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentRejectAudit = <NUDATA extends (keyof AT_FlowRentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Rent/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentDynamicRejectAudit = <NUDATA extends (keyof AT_FlowRentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Rent/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentSaveDraft = <NUDATA extends (keyof AT_FlowRentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Rent/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentSubmitAudit = <NUDATA extends (keyof AT_FlowRentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Rent/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentResetAudit = <NUDATA extends (keyof AT_FlowRentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Rent/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowRentGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowRentGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeflowRentApplyDeleteRentApplyFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRentApplyDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowRentApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentApply/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentApplyPendingAudit = <NUDATA extends (keyof AT_FlowRentApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentApply/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentApplyRejectAudit = <NUDATA extends (keyof AT_FlowRentApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentApply/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentApplyDynamicRejectAudit = <NUDATA extends (keyof AT_FlowRentApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentApply/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentApplySaveDraft = <NUDATA extends (keyof AT_FlowRentApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentApply/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentApplySubmitAudit = <NUDATA extends (keyof AT_FlowRentApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentApply/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentApplyResetAudit = <NUDATA extends (keyof AT_FlowRentApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentApply/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowRentApplyGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowRentApplyGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowRentOutDeleteRentOutFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowRentOutDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowRentOutModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentOut/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentOutPendingAudit = <NUDATA extends (keyof AT_FlowRentOutModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentOut/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentOutRejectAudit = <NUDATA extends (keyof AT_FlowRentOutModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentOut/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentOutDynamicRejectAudit = <NUDATA extends (keyof AT_FlowRentOutModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentOut/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentOutSaveDraft = <NUDATA extends (keyof AT_FlowRentOutModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentOut/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentOutSubmitAudit = <NUDATA extends (keyof AT_FlowRentOutModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentOut/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRentOutResetAudit = <NUDATA extends (keyof AT_FlowRentOutModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/RentOut/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowRentOutGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowRentOutGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowResignDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowResignModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Resign/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignPendingAudit = <NUDATA extends (keyof AT_FlowResignModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Resign/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignRejectAudit = <NUDATA extends (keyof AT_FlowResignModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Resign/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignDynamicRejectAudit = <NUDATA extends (keyof AT_FlowResignModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Resign/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignResetAudit = <NUDATA extends (keyof AT_FlowResignModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Resign/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignSaveDraft = <NUDATA extends (keyof AT_FlowResignModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Resign/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignSubmitAudit = <NUDATA extends (keyof AT_FlowResignModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Resign/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowResignGetResignByFlowId = <RNU extends (keyof AT_FlowModelResignViewModelTuple)[] = []>(
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowResignDeleteResign = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Resign/DeleteResign?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowResignGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowResignGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeflowResignComplexDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowResignComplexModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignComplex/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignComplexPendingAudit = <NUDATA extends (keyof AT_FlowResignComplexModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignComplex/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignComplexRejectAudit = <NUDATA extends (keyof AT_FlowResignComplexModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignComplex/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignComplexDynamicRejectAudit = <NUDATA extends (keyof AT_FlowResignComplexModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignComplex/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignComplexResetAudit = <NUDATA extends (keyof AT_FlowResignComplexModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignComplex/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignComplexSaveDraft = <NUDATA extends (keyof AT_FlowResignComplexModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignComplex/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignComplexSubmitAudit = <NUDATA extends (keyof AT_FlowResignComplexModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignComplex/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowResignComplexDeleteResignComplex = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/ResignComplex/DeleteResignComplex?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowResignComplexGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowResignComplexGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowResignDepDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowResignDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignDep/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignDepPendingAudit = <NUDATA extends (keyof AT_FlowResignDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignDep/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignDepRejectAudit = <NUDATA extends (keyof AT_FlowResignDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignDep/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignDepDynamicRejectAudit = <NUDATA extends (keyof AT_FlowResignDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignDep/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignDepResetAudit = <NUDATA extends (keyof AT_FlowResignDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignDep/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignDepSaveDraft = <NUDATA extends (keyof AT_FlowResignDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignDep/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignDepSubmitAudit = <NUDATA extends (keyof AT_FlowResignDepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignDep/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowResignDepDeleteResignDep = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/ResignDep/DeleteResignDep?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowResignDepGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowResignDepGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowResignFinanceDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowResignFinanceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignFinance/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignFinancePendingAudit = <NUDATA extends (keyof AT_FlowResignFinanceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignFinance/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignFinanceRejectAudit = <NUDATA extends (keyof AT_FlowResignFinanceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignFinance/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignFinanceDynamicRejectAudit = <NUDATA extends (keyof AT_FlowResignFinanceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignFinance/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignFinanceResetAudit = <NUDATA extends (keyof AT_FlowResignFinanceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignFinance/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignFinanceSaveDraft = <NUDATA extends (keyof AT_FlowResignFinanceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignFinance/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignFinanceSubmitAudit = <NUDATA extends (keyof AT_FlowResignFinanceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignFinance/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowResignFinanceDeleteResignFinance = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/ResignFinance/DeleteResignFinance?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowResignFinanceGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowResignFinanceGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowResignInfoDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowResignInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignInfo/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignInfoPendingAudit = <NUDATA extends (keyof AT_FlowResignInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignInfo/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignInfoRejectAudit = <NUDATA extends (keyof AT_FlowResignInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignInfo/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignInfoDynamicRejectAudit = <NUDATA extends (keyof AT_FlowResignInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignInfo/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignInfoResetAudit = <NUDATA extends (keyof AT_FlowResignInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignInfo/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignInfoSaveDraft = <NUDATA extends (keyof AT_FlowResignInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignInfo/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowResignInfoSubmitAudit = <NUDATA extends (keyof AT_FlowResignInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/ResignInfo/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowResignInfoDeleteResignInfo = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/ResignInfo/DeleteResignInfo?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowResignInfoGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowResignInfoGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeResumeRemoveResumeAttachment = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/Resume/RemoveResumeAttachment?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeResumeGetResumeAttachments = <RNU extends (keyof AT_ResumeAttachmentViewModel)[] = []>(
	resumeHoldId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeResumeGetResumeWorks = <RNU extends (keyof AT_ResumeWorkViewModel)[] = []>(resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeResumeGetResumeStudys = <RNU extends (keyof AT_ResumeStudyViewModel)[] = []>(resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeResumeRemoveResumeWork = (id: number, resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeResumeRemoveResumeStudy = (id: number, resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeResumeTalentNoteHandle = <NUDATA extends (keyof AT_ResumeTalentNoteModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Resume/TalentNoteHandle?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeResumeGetResumeTalentNote = <RNU extends (keyof AT_ResumeTalentNoteViewModel)[] = []>(
	resumeHoldId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeResumeLinkUp = <NUDATA extends (keyof AT_ResumeInteractModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Resume/LinkUp?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeResumeToInterview = (resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/Resume/ToInterview?${resumeHoldId ? 'resumeHoldId=' + resumeHoldId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeResumeGetResumeShareToUsers = <RNU extends (keyof AT_StaffInfo)[] = []>(resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_StaffInfo, RNU>[]>>(
		`/${FirmCodeURL}/Resume/GetResumeShareToUsers?${resumeHoldId ? 'resumeHoldId=' + resumeHoldId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeResumeResumeShareRead = (resumeShareId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeResumeResumeHold = <NUDATA extends (keyof AT_ResumeHoldModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Resume/ResumeHold?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeResumeGetResumeHoldFirm = <RNU extends (keyof AT_FirmSimpleModel)[] = []>(resumeId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FirmSimpleModel, RNU>[]>>(
...
export const getFirmCodeResumeGetResumeById = <RNU extends (keyof AT_ResumeViewModel)[] = []>(resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeResumeGetResumeTimeline = <RNU extends (keyof AT_TimelineModel)[] = []>(resumeHoldId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeResumeResumeImport = <RNU extends (keyof AT_ResumeModel)[] = []>(FirmCode: string, data: { formFile: string }) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowRewardGetRewardByUser = <RNU extends (keyof AT_GetRewardByUserModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowRewardDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowRewardModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Reward/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRewardPendingAudit = <NUDATA extends (keyof AT_FlowRewardModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Reward/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRewardRejectAudit = <NUDATA extends (keyof AT_FlowRewardModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Reward/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRewardDynamicRejectAudit = <NUDATA extends (keyof AT_FlowRewardModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Reward/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRewardResetAudit = <NUDATA extends (keyof AT_FlowRewardModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Reward/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRewardSaveDraft = <NUDATA extends (keyof AT_FlowRewardModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Reward/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowRewardSubmitAudit = <NUDATA extends (keyof AT_FlowRewardModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Reward/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowRewardGetRewardByFlowId = <RNU extends (keyof AT_FlowModelRewardViewModelTuple)[] = []>(
	flowId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowRewardDeleteReward = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Reward/DeleteReward?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowRewardGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowRewardGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowChatModel, RNU>[]>>(
...
export const postFirmCodeRewardSubjectSaveRewardSubject = <NUDATA extends (keyof AT_RewardSubjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/RewardSubject/SaveRewardSubject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeRewardSubjectDeleteRewardSubject = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/RewardSubject/DeleteRewardSubject?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeRewardSubjectGetRewardSubjectById = <RNU extends (keyof AT_RewardSubjectModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_RewardSubjectModel, RNU>>>(
		`/${FirmCodeURL}/RewardSubject/GetRewardSubjectById?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeRoleAddRole = <NUDATA extends (keyof AT_RoleModel)[] = []>(FirmCode: string, data: U_I_NoNull<AT_RoleModel, NUDATA>) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Role/AddRole?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeRoleRemoveRole = (roleId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeRoleGetRoleById = <RNU extends (keyof AT_RoleViewModel)[] = []>(roleId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeRoleGetRoleList = <RNU extends (keyof AT_RoleViewModel)[] = []>(roleName: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_RoleViewModel, RNU>[]>>(
...
export const postFirmCodeRoleDispatchRole = <NUDATA extends (keyof AT_DispatchRoleModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Role/DispatchRole?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeRoleGetRoleStaff = <RNU extends (keyof AT_RoleUserViewModel)[] = []>(roleId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowSalaryConfirmDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowSalaryConfirmModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryConfirm/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryConfirmPendingAudit = <NUDATA extends (keyof AT_FlowSalaryConfirmModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryConfirm/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryConfirmRejectAudit = <NUDATA extends (keyof AT_FlowSalaryConfirmModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryConfirm/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryConfirmDynamicRejectAudit = <NUDATA extends (keyof AT_FlowSalaryConfirmModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryConfirm/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryConfirmResetAudit = <NUDATA extends (keyof AT_FlowSalaryConfirmModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryConfirm/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryConfirmSaveDraft = <NUDATA extends (keyof AT_FlowSalaryConfirmModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryConfirm/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryConfirmSubmitAudit = <NUDATA extends (keyof AT_FlowSalaryConfirmModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryConfirm/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowSalaryConfirmDeleteSalaryCalculate = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/SalaryConfirm/DeleteSalaryCalculate?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowSalaryConfirmGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowSalaryConfirmGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeSalaryDeductAddUpdateSalaryDeduct = <NUDATA extends (keyof AT_SalaryDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SalaryDeduct/AddUpdateSalaryDeduct?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeSalaryDeductGetSalaryDeductById = <RNU extends (keyof AT_SalaryDeductViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_SalaryDeductViewModel, RNU>>>(
...
export const postFirmCodeSalaryDeductConfirmDetailsState = (FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SalaryDeduct/ConfirmDetailsState?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeSalaryDeductCalculateDeductMoney = (barCode: string, deductDays: number, deductMonthToString: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<number>>(
		`/${FirmCodeURL}/SalaryDeduct/CalculateDeductMoney?${barCode ? 'barCode=' + barCode : ''}&${deductDays ? 'deductDays=' + deductDays : ''}&${
			deductMonthToString ? 'deductMonthToString=' + deductMonthToString : ''
		}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
...
export const postFirmCodeflowSalaryKeepDeductDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowSalaryKeepDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/SalaryKeepDeduct/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowSalaryKeepDeductPendingAudit = <NUDATA extends (keyof AT_FlowSalaryKeepDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryKeepDeduct/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryKeepDeductRejectAudit = <NUDATA extends (keyof AT_FlowSalaryKeepDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryKeepDeduct/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryKeepDeductDynamicRejectAudit = <NUDATA extends (keyof AT_FlowSalaryKeepDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/SalaryKeepDeduct/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowSalaryKeepDeductResetAudit = <NUDATA extends (keyof AT_FlowSalaryKeepDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryKeepDeduct/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryKeepDeductSaveDraft = <NUDATA extends (keyof AT_FlowSalaryKeepDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryKeepDeduct/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryKeepDeductSubmitAudit = <NUDATA extends (keyof AT_FlowSalaryKeepDeductModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryKeepDeduct/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowSalaryKeepDeductDeleteSalaryKeepDeductByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/SalaryKeepDeduct/DeleteSalaryKeepDeductByFlowId?${flowId ? 'flowId=' + flowId : ''}&${
			FirmCode ? 'FirmCode=' + FirmCode : ''
		}`
	);
};
export const getFirmCodeflowSalaryKeepDeductGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeSalaryKeepRecordDistributeReservedSalary = <NUDATA extends (keyof AT_SalaryKeepGrantRecordModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/SalaryKeepRecord/DistributeReservedSalary?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
...
export const postFirmCodeSalaryRecordChangePrintStateBySalaryCalculateGrantIdCode = (FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeSalaryRecordBatchExportSalaryRecord = <NUDATA extends (keyof AT_SalaryRecordQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SalaryRecord/BatchExportSalaryRecord?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowSalaryStaffDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowSalaryStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffPendingAudit = <NUDATA extends (keyof AT_FlowSalaryStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffRejectAudit = <NUDATA extends (keyof AT_FlowSalaryStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffDynamicRejectAudit = <NUDATA extends (keyof AT_FlowSalaryStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffResetAudit = <NUDATA extends (keyof AT_FlowSalaryStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffSaveDraft = <NUDATA extends (keyof AT_FlowSalaryStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffSubmitAudit = <NUDATA extends (keyof AT_FlowSalaryStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowSalaryStaffGetSalaryStaffById = <RNU extends (keyof AT_SalaryStaffViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowSalaryStaffGetUserAuditPower = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowSalaryStaffUpdateSalaryStaffState = <NUDATA extends (keyof AT_SalaryStaffStateModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/UpdateSalaryStaffState?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffMergeSalaryCustomGrant = <NUDATA extends (keyof AT_MergeSalaryPaymentMethodModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SalaryStaff/MergeSalaryCustomGrant?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSalaryStaffStopProvideSalaryBySalaryIds = (FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowSalaryStaffGetSalaryKeepByBarCode = (barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<number>>(
...
export const postFirmCodeflowSalaryStaffDeleteSalaryById = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeflowSalaryStaffGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowSalaryStaffGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeSalarySubjectSaveSalarySubject = <NUDATA extends (keyof AT_SalarySubjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SalarySubject/SaveSalarySubject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeSalarySubjectDeleteSalarySubject = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/SalarySubject/DeleteSalarySubject?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeSalarySubjectGetSalarySubjectById = <RNU extends (keyof AT_SalarySubjectModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_SalarySubjectModel, RNU>>>(
...
export const postFirmCodeSalaryVerifyBatchSalaryConfirm = (FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SalaryVerify/BatchSalaryConfirm?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeSalaryVerifyBatchSalaryVerify = (paymentDays: string, FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeSalaryVerifyGetSalaryAdvancePaymentById = <RNU extends (keyof AT_SalaryStaffViewModel)[] = []>(
	id: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeSalaryVerifyGetSalaryCalculateGrantPersonalIncomeMoney = (id: number, barcode: string, days: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<number>>(
...
export const postFirmCodeSlaveCardBagBatchExportSlaveCardRecharge = <NUDATA extends (keyof AT_SlaveCardBagQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/SlaveCardBag/BatchExportSlaveCardRecharge?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeSlaveCardBagSaveSlaveCardBag = <NUDATA extends (keyof AT_SlaveCardBagModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SlaveCardBag/SaveSlaveCardBag?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeSlaveCardBagGetSlaveCardBagById = <RNU extends (keyof AT_SlaveCardBagModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeSlaveCardBagGetSlaveCardBagByCardCode = <RNU extends (keyof AT_SlaveCardBagModel)[] = []>(
	cardCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeSlaveCardBagChangeSlaveCardBagState = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowSlaveCardRechargeApplyBatchExportSlaveCardRechargeApply = (FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowSlaveCardRechargeApplyPendingAudit = <NUDATA extends (keyof AT_FlowSlaveCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/SlaveCardRechargeApply/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowSlaveCardRechargeApplyRejectAudit = <NUDATA extends (keyof AT_FlowSlaveCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SlaveCardRechargeApply/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowSlaveCardRechargeApplyResetAudit = <NUDATA extends (keyof AT_FlowSlaveCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SlaveCardRechargeApply/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSlaveCardRechargeApplySaveDraft = <NUDATA extends (keyof AT_FlowSlaveCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SlaveCardRechargeApply/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowSlaveCardRechargeApplySubmitAudit = <NUDATA extends (keyof AT_FlowSlaveCardRechargeApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/SlaveCardRechargeApply/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowSlaveCardRechargeApplyGetOilCardByCardCode = (cardCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<string>>(
...
export const postFirmCodeflowSlaveCardRechargeApplyDeleteSlaveCardRechargeApply = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeSocialInsuranceBatchExport = (FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SocialInsurance/BatchExport?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeSocialInsuranceAddSocialInsurance = <NUDATA extends (keyof AT_SocialInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SocialInsurance/AddSocialInsurance?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeSocialInsuranceGetSocialInsuranceById = <RNU extends (keyof AT_SocialInsuranceViewModel)[] = []>(
	id: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeSocialInsuranceChangeInsuranceState = (id: number, insuranceState: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeSocialInsuranceBatchChangeInsuranceState = (insuranceState: number, FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeSocialInsuranceBatchDeleteSocialInsuranceDetails = (SubjectId: number, FirmCode: string, data: number[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowSocialInsurancePaySocialInsurancePay = <NUDATA extends (keyof AT_SocialInsurancePayModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/SocialInsurancePay/SocialInsurancePay?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const getFirmCodeflowSocialInsurancePayGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeSocialInsuranceSchemeDeleteSocialInsuranceScheme = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeSocialInsuranceSubjectDeleteSocialInsuranceSubject = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/SocialInsuranceSubject/DeleteSocialInsuranceSubject?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeStaffDetailsGetStaffDetailsByBarCode = <RNU extends (keyof AT_StaffDetailsViewModel)[] = []>(
	barCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeStaffDetailsUpdateStaffSelfEvaluation = <NUDATA extends (keyof AT_StaffSelfEvaluationModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/UpdateStaffSelfEvaluation?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeStaffDetailsUpdateStaffHonor = <NUDATA extends (keyof AT_StaffHonorModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/UpdateStaffHonor?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeStaffDetailsUpdateFamilyInfo = <NUDATA extends (keyof AT_EntryFamilyInfoModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/UpdateFamilyInfo?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeStaffDetailsRemoveFamilyInfo = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/StaffDetails/RemoveFamilyInfo?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeStaffDetailsGetFamilyInfoList = <RNU extends (keyof AT_EntryFamilyInfoModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeStaffDetailsUpdateStaffBank = <NUDATA extends (keyof AT_StaffBankModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/UpdateStaffBank?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeStaffDetailsRemoveStaffBank = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/StaffDetails/RemoveStaffBank?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeStaffDetailsGetStaffBankList = <RNU extends (keyof AT_StaffBankModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeStaffDetailsUpdateAttachment = <NUDATA extends (keyof AT_InductionAttachmentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/UpdateAttachment?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeStaffDetailsRemoveAttachment = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/StaffDetails/RemoveAttachment?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeStaffDetailsGetAttachmentList = <RNU extends (keyof AT_InductionAttachmentModel)[] = []>(
	barCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeStaffDetailsUpdateStudy = <NUDATA extends (keyof AT_InductionStudyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/UpdateStudy?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeStaffDetailsRemoveStudy = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/StaffDetails/RemoveStudy?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeStaffDetailsGetStudyList = <RNU extends (keyof AT_InductionStudyModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeStaffDetailsUpdateWork = <NUDATA extends (keyof AT_InductionWorkModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/UpdateWork?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeStaffDetailsRemoveWork = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/StaffDetails/RemoveWork?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeStaffDetailsGetWorkList = <RNU extends (keyof AT_InductionWorkModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeStaffDetailsUpdateProfilePicture = (barcode: string, profilePicture: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeStaffDetailsExportStaffDetailsList = <NUDATA extends (keyof AT_StaffDetailsQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/StaffDetails/ExportStaffDetailsList?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postSuperAdminRegisterFirm = <NUDATA extends (keyof AT_FirmModel)[] = []>(data: U_I_NoNull<AT_FirmModel, NUDATA>) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/RegisterFirm`, data);
};
export const postSuperAdminUpdateFirm = <NUDATA extends (keyof AT_FirmModel)[] = []>(data: U_I_NoNull<AT_FirmModel, NUDATA>) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/UpdateFirm`, data);
};
...
export const postSuperAdminRemoveScheme = (schemeCode: string) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/RemoveScheme?${schemeCode ? 'schemeCode=' + schemeCode : ''}`);
};
...
export const postSuperAdminAddScheme = (schemeName: string) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/AddScheme?${schemeName ? 'schemeName=' + schemeName : ''}`);
};
...
export const postOAOpenSystem = <NUDATA extends (keyof AT_OpenSystemModel)[] = []>(data: U_I_NoNull<AT_OpenSystemModel, NUDATA>) => {
	return axios.post<ResponseData<boolean>>(`/OA/OpenSystem`, data);
};
...
export const postSuperAdminRemovePageRoute = (pageRoutId: number) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/RemovePageRoute?${pageRoutId ? 'pageRoutId=' + pageRoutId : ''}`);
};
...
export const postSuperAdminRemovePopupRoute = (popupRoutId: number) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/RemovePopupRoute?${popupRoutId ? 'popupRoutId=' + popupRoutId : ''}`);
};
export const postSuperAdminAddComboBox = <NUDATA extends (keyof AT_ComboBoxModel)[] = []>(data: U_I_NoNull<AT_ComboBoxModel, NUDATA>) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/AddComboBox`, data);
};
export const postSuperAdminRemoveComboBox = (comboBoxId: number) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/RemoveComboBox?${comboBoxId ? 'comboBoxId=' + comboBoxId : ''}`);
};
export const postSuperAdminUpdateComboBox = <NUDATA extends (keyof AT_ComboBoxModel)[] = []>(
	comboBoxId: number,
	data: U_I_NoNull<AT_ComboBoxModel, NUDATA>
) => {
	return axios.post<ResponseData<boolean>>(`/SuperAdmin/UpdateComboBox?${comboBoxId ? 'comboBoxId=' + comboBoxId : ''}`, data);
};
...
export const postFirmCodeSysConfigMergeSysConfig = <NUDATA extends (keyof AT_UserConfigModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/SysConfig/MergeSysConfig?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeSysRouteGetSysPopupRouteById = <RNU extends (keyof AT_SysPopupRouteViewModel)[] = []>(
	popupRoutId: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowTaxCreditApplyDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowTaxCreditApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TaxCreditApply/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTaxCreditApplyPendingAudit = <NUDATA extends (keyof AT_FlowTaxCreditApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TaxCreditApply/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTaxCreditApplyRejectAudit = <NUDATA extends (keyof AT_FlowTaxCreditApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TaxCreditApply/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTaxCreditApplyDynamicRejectAudit = <NUDATA extends (keyof AT_FlowTaxCreditApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TaxCreditApply/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTaxCreditApplyResetAudit = <NUDATA extends (keyof AT_FlowTaxCreditApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TaxCreditApply/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTaxCreditApplySaveDraft = <NUDATA extends (keyof AT_FlowTaxCreditApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TaxCreditApply/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTaxCreditApplySubmitAudit = <NUDATA extends (keyof AT_FlowTaxCreditApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TaxCreditApply/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowTaxCreditApplyGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowTaxCreditApplyGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeTaxCreditSubjectSaveTaxCreditSubject = <NUDATA extends (keyof AT_TaxCreditSubjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/TaxCreditSubject/SaveTaxCreditSubject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeTaxCreditSubjectDeleteTaxCreditSubject = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/TaxCreditSubject/DeleteTaxCreditSubject?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeTaxCreditSubjectGetTaxCreditSubjectById = <RNU extends (keyof AT_TaxCreditSubjectModel)[] = []>(
	id: number,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeTeachingGetTeachingById = <RNU extends (keyof AT_TeachingViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeTeachingAddTeaching = <NUDATA extends (keyof AT_TeachingModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Teaching/AddTeaching?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeTeachingDetailsStartTeaching = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/TeachingDetails/StartTeaching?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const postFirmCodeTeachingDetailsEndTeaching = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeTeachTemplateGetTeachById = <RNU extends (keyof AT_TeachTemplateViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeTeachTemplateAddTeachTemplate = <NUDATA extends (keyof AT_TeachTemplateModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/TeachTemplate/AddTeachTemplate?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeTeachTemplateRemoveTeachByFlowId = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeTrademarkAddTrademark = <NUDATA extends (keyof AT_TrademarkModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Trademark/AddTrademark?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeTrademarkGetTrademarkById = <RNU extends (keyof AT_TrademarkViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeTrademarkRemoveTrademark = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeflowTransferGetTransfer = <RNU extends (keyof AT_TransferByBarCodeModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowTransferDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowTransferModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Transfer/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTransferPendingAudit = <NUDATA extends (keyof AT_FlowTransferModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Transfer/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTransferRejectAudit = <NUDATA extends (keyof AT_FlowTransferModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Transfer/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTransferDynamicRejectAudit = <NUDATA extends (keyof AT_FlowTransferModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Transfer/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTransferResetAudit = <NUDATA extends (keyof AT_FlowTransferModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Transfer/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTransferSaveDraft = <NUDATA extends (keyof AT_FlowTransferModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Transfer/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTransferSubmitAudit = <NUDATA extends (keyof AT_FlowTransferModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Transfer/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowTransferCheckTransferUserIsInFlow = (barCode: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowTransferCheckIsExistDepPost = (barCode: string, depCode: string, postCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowTransferDeleteTransfer = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Transfer/DeleteTransfer?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowTransferGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowTransferGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeTransferStaffAddTransferStaff = <NUDATA extends (keyof AT_TransferStaffModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/TransferStaff/AddTransferStaff?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeTransferStaffGetTransferStaffById = <RNU extends (keyof AT_TransferStaffViewModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const getFirmCodeflowTryoutUpGetTryoutUpByBarCode = <RNU extends (keyof AT_TryoutUpViewModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowTryoutUpDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowTryoutUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTryoutUpPendingAudit = <NUDATA extends (keyof AT_FlowTryoutUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTryoutUpRejectAudit = <NUDATA extends (keyof AT_FlowTryoutUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTryoutUpDynamicRejectAudit = <NUDATA extends (keyof AT_FlowTryoutUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTryoutUpResetAudit = <NUDATA extends (keyof AT_FlowTryoutUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTryoutUpSaveDraft = <NUDATA extends (keyof AT_FlowTryoutUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTryoutUpSubmitAudit = <NUDATA extends (keyof AT_FlowTryoutUpModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowTryoutUpDeleteTryoutUp = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowTryoutUpAddStaffGrowAttachment = <NUDATA extends (keyof AT_StaffGrowAttachmentModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/TryoutUp/AddStaffGrowAttachment?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowTryoutUpGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowTryoutUpGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeVehicleAddVehicle = <NUDATA extends (keyof AT_VehicleModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Vehicle/AddVehicle?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeVehicleBlockVehicle = <NUDATA extends (keyof AT_BlockVehicleModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/Vehicle/BlockVehicle?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeVehicleGetBlockVehicle = <RNU extends (keyof AT_BlockVehicleModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeVehicleBatchVehicleHoldShare = (vehicleId: number, FirmCode: string, data: string[]) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeVehicleGetVehicleHoldByVehicleId = <RNU extends (keyof AT_VehicleHoldModel)[] = []>(vehicleId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowVehicleApplyDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleApply/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleApplyPendingAudit = <NUDATA extends (keyof AT_FlowVehicleApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleApply/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleApplyRejectAudit = <NUDATA extends (keyof AT_FlowVehicleApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleApply/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleApplyDynamicRejectAudit = <NUDATA extends (keyof AT_FlowVehicleApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleApply/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleApplyResetAudit = <NUDATA extends (keyof AT_FlowVehicleApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleApply/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleApplySaveDraft = <NUDATA extends (keyof AT_FlowVehicleApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleApply/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleApplySubmitAudit = <NUDATA extends (keyof AT_FlowVehicleApplyModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleApply/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowVehicleApplyDeleteVehicleApplyByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/VehicleApply/DeleteVehicleApplyByFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowVehicleApplyGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowVehicleApplyGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowVehicleInsuranceDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/VehicleInsurance/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowVehicleInsurancePendingAudit = <NUDATA extends (keyof AT_FlowVehicleInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleInsurance/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleInsuranceRejectAudit = <NUDATA extends (keyof AT_FlowVehicleInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleInsurance/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleInsuranceDynamicRejectAudit = <NUDATA extends (keyof AT_FlowVehicleInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/VehicleInsurance/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`,
		data
	);
};
export const postFirmCodeflowVehicleInsuranceResetAudit = <NUDATA extends (keyof AT_FlowVehicleInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleInsurance/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleInsuranceSaveDraft = <NUDATA extends (keyof AT_FlowVehicleInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleInsurance/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleInsuranceSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleInsuranceModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleInsurance/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowVehicleInsuranceDeleteVehicleInsuranceByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const getFirmCodeflowVehicleInsuranceGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowVehicleLeaseDeleteVehicleLeaseByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowVehicleLeaseVehicleLeaseCost = <NUDATA extends (keyof AT_VehicleLeaseCostModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/VehicleLeaseCost?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeaseVehicleLeaseReturn = <NUDATA extends (keyof AT_VehicleLeaseReturnModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/VehicleLeaseReturn?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeaseDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleLeaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeasePendingAudit = <NUDATA extends (keyof AT_FlowVehicleLeaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeaseRejectAudit = <NUDATA extends (keyof AT_FlowVehicleLeaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeaseDynamicRejectAudit = <NUDATA extends (keyof AT_FlowVehicleLeaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeaseResetAudit = <NUDATA extends (keyof AT_FlowVehicleLeaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeaseSaveDraft = <NUDATA extends (keyof AT_FlowVehicleLeaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleLeaseSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleLeaseModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleLease/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const getFirmCodeflowVehicleLeaseGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowVehicleLeaseGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowVehicleRepairDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleRepairModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleRepair/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleRepairPendingAudit = <NUDATA extends (keyof AT_FlowVehicleRepairModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleRepair/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleRepairRejectAudit = <NUDATA extends (keyof AT_FlowVehicleRepairModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleRepair/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleRepairDynamicRejectAudit = <NUDATA extends (keyof AT_FlowVehicleRepairModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleRepair/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleRepairResetAudit = <NUDATA extends (keyof AT_FlowVehicleRepairModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleRepair/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleRepairSaveDraft = <NUDATA extends (keyof AT_FlowVehicleRepairModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleRepair/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleRepairSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleRepairModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleRepair/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowVehicleRepairDeleteVehicleRepairByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/VehicleRepair/DeleteVehicleRepairByFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowVehicleRepairGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowVehicleRepairGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeflowVehicleUpkeepDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleUpkeepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleUpkeep/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleUpkeepPendingAudit = <NUDATA extends (keyof AT_FlowVehicleUpkeepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleUpkeep/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleUpkeepRejectAudit = <NUDATA extends (keyof AT_FlowVehicleUpkeepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleUpkeep/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleUpkeepDynamicRejectAudit = <NUDATA extends (keyof AT_FlowVehicleUpkeepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleUpkeep/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleUpkeepResetAudit = <NUDATA extends (keyof AT_FlowVehicleUpkeepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleUpkeep/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleUpkeepSaveDraft = <NUDATA extends (keyof AT_FlowVehicleUpkeepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleUpkeep/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVehicleUpkeepSubmitAudit = <NUDATA extends (keyof AT_FlowVehicleUpkeepModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VehicleUpkeep/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowVehicleUpkeepDeleteVehicleUpkeepByFlowId = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/VehicleUpkeep/DeleteVehicleUpkeepByFlowId?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowVehicleUpkeepGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowVehicleUpkeepGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const getFirmCodeflowVirtueFundGetVirtueFundByUser = <RNU extends (keyof AT_GetVirtueFundByUserModel)[] = []>(
	barCode: string,
	FirmCode: string
) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowVirtueFundBatchExportVirtueFund = <NUDATA extends (keyof AT_VirtueFundQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/BatchExportVirtueFund?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowVirtueFundDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowVirtueFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVirtueFundPendingAudit = <NUDATA extends (keyof AT_FlowVirtueFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVirtueFundRejectAudit = <NUDATA extends (keyof AT_FlowVirtueFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVirtueFundDynamicRejectAudit = <NUDATA extends (keyof AT_FlowVirtueFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVirtueFundResetAudit = <NUDATA extends (keyof AT_FlowVirtueFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVirtueFundSaveDraft = <NUDATA extends (keyof AT_FlowVirtueFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowVirtueFundSubmitAudit = <NUDATA extends (keyof AT_FlowVirtueFundModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/VirtueFund/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowVirtueFundDeleteVirtueFund = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/VirtueFund/DeleteVirtueFund?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowVirtueFundGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowVirtueFundGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeVirtueSubjectSaveVirtueSubject = <NUDATA extends (keyof AT_VirtueSubjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/VirtueSubject/SaveVirtueSubject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeVirtueSubjectGetVirtueSubjectById = <RNU extends (keyof AT_VirtueSubjectModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeVirtueSubjectDeleteVirtueSubject = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
...
export const postFirmCodeflowWelfareBatchExportWelfare = <NUDATA extends (keyof AT_WelfareQueryModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/BatchExportWelfare?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const getFirmCodeflowWelfareGetWelfareByUser = <RNU extends (keyof AT_GetWelfareByUserModel)[] = []>(barCode: string, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
...
export const postFirmCodeflowWelfareDynamicSubmitAudit = <NUDATA extends (keyof AT_FlowWelfareModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/DynamicSubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowWelfarePendingAudit = <NUDATA extends (keyof AT_FlowWelfareModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/PendingAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowWelfareRejectAudit = <NUDATA extends (keyof AT_FlowWelfareModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/RejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowWelfareDynamicRejectAudit = <NUDATA extends (keyof AT_FlowWelfareModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/DynamicRejectAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowWelfareResetAudit = <NUDATA extends (keyof AT_FlowWelfareModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/ResetAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowWelfareSaveDraft = <NUDATA extends (keyof AT_FlowWelfareModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/SaveDraft?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeflowWelfareSubmitAudit = <NUDATA extends (keyof AT_FlowWelfareModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/flow/Welfare/SubmitAudit?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
...
export const postFirmCodeflowWelfareDeleteWelfare = (flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/flow/Welfare/DeleteWelfare?${flowId ? 'flowId=' + flowId : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeflowWelfareGetFlowInfo = <RNU extends (keyof AT_FlowModel)[] = []>(popupKey: string, flowId: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_FlowModel, RNU>>>(
...
export const getFirmCodeflowWelfareGetFlowChat = <RNU extends (keyof AT_FlowChatModel)[] = []>(
	popupKey: string,
	flowId: number,
	FirmCode: string
) => {
...
export const postFirmCodeWelfareSubjectSaveWelfareSubject = <NUDATA extends (keyof AT_WelfareSubjectModel)[] = []>(
	...
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(`/${FirmCodeURL}/WelfareSubject/SaveWelfareSubject?${FirmCode ? 'FirmCode=' + FirmCode : ''}`, data);
};
export const postFirmCodeWelfareSubjectDeleteWelfareSubject = (id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.post<ResponseData<boolean>>(
		`/${FirmCodeURL}/WelfareSubject/DeleteWelfareSubject?${id ? 'id=' + id : ''}&${FirmCode ? 'FirmCode=' + FirmCode : ''}`
	);
};
export const getFirmCodeWelfareSubjectGetWelfareSubjectById = <RNU extends (keyof AT_WelfareSubjectModel)[] = []>(id: number, FirmCode: string) => {
	const FirmCodeURL = COMPANY_CODE;
	return axios.get<ResponseData<U_I_NoNull<AT_WelfareSubjectModel, RNU>>>(
